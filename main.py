...
DATABASE_URL = os.getenv("DATABASE_URL", "PEGA_AQUI_TU_URL_DE_NEON_TECH")
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://tunombre.github.io", "http://localhost:5173"],
...
@app.get("/")
def read_root():
    return {"status": "API en linea, CORS configurado, DB conectada"}